...
* [IoT Device Programming](lab/iot-device-programming/README.md)
  ...
  * [CircuitPython Basics](lab/iot-device-programming/circuitpython-basics/README.md)
    * [Serial Console](lab/iot-device-programming/circuitpython-basics/serial-console.md)
    * [Board Pins](lab/iot-device-programming/circuitpython-basics/board-pins.md)
    * [Built-In Modules](lab/iot-device-programming/circuitpython-basics/built-in-modules.md)
  ...
  * [BLE Connectivity](lab/iot-device-programming/ble-connectivity/README.md)
    * [BLE Advertisement](lab/iot-device-programming/ble-connectivity/ble-advertisement.md)
    * [BLE Eddystone Beacon](lab/iot-device-programming/ble-connectivity/ble-eddystone-beacon.md)
    * [BLE Custom Service](lab/iot-device-programming/ble-connectivity/ble-custom-service.md)
...
* [Azure ML Studio](lab/azure-ml-studio/README.md)
  * [Create Resource Group](lab/azure-ml-studio/create-resource-group.md)
  * [Create ML Workspace](lab/azure-ml-studio/create-ml-workspace.md)
  * [Create Storage Account](lab/azure-ml-studio/create-storage-account.md)
  * [Create Datastore](lab/azure-ml-studio/create-datastore.md)
